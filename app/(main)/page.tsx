    ...
    return (
        <div className='max-w-4xl mx-auto'>
            ...
            <p className='text-slate-300 mb-8'>
                showing Nextjs 16 role control features wiht role-based permissions.
            </p>
            ...
            {user ? (
                <div className='bg-green-900/30 border border-green-600 rounded-lg p-4'>
                    <p className='text-green-300'>
                        Welcome back, <strong>Deepak</strong> ! You are logged in as {""}
                ...
                <div className='bg-blue-900/30 border border-blue-600 rounded-lg p-4'>
                    ...
                    <Link href="/login" className='inline-block mt-3 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors'>
                    Login
                    </Link>
