        ...
        <div className="bg-slate-800 p-8 rounded-lg border border-slate-700 w-full max-w-md">
            <form action={LoginAction}>
                <div className="text-center mb-8">
                    <h2 className="text-2xl font-bold text-white">Sign in to you account</h2>
                    <p className="mt-2 text-sm text-slate-400">
                        or{" "}
                        <Link href="/register" className="font-medium text-blue-400 hover:text-blue-300">Create an account</Link>
                    </p>
                </div>
                {state?.error && (
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            autoComplete="email"
                            required
                            className="w-full px-3 py-2 bg-slate-900 border border-slate-500 focus:outline-none rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
